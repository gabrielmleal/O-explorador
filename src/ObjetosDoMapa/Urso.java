...
public class Urso extends Inimigo {
    ...
    public Urso(MapaDeBlocos mb) {
        super(mb);
        velMovimento = velMaxMovimento = 0.6; // Slightly slower than wolves
        velQueda = 0.2;
        velMaxQueda = 3.5;
        ...
        vida = maxVida = 5; // More health than wolves
        dano = 2; // More damage than wolves
        
        try{
            // Using wolf sprite as placeholder since no bear sprite exists
        ...
        animacao.mudarIntervaloPara(130); // Slightly slower animation than wolves
